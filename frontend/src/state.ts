...
/** Common name if the genus has one on iNat, else the scientific name (same fallback as genera.ts's
 * search results - most of the ~6,018-genus catalog lacks an English common name). */
